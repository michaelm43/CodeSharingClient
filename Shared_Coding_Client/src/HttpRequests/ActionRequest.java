...
//	public static String IP = "192.168.1.22";
	...
	public boolean lockLines(User user, Project proj, int start, int count) {
		...
		try {
			...
			Action action = new Action("lock", proj.getKey(), user.getEmail());
	...
	public boolean unlockLines(User user, Project proj, int start, int count) {
		...
		try {
			...
			Action action = new Action("unlock", proj.getKey(), user.getEmail());
	...
	public boolean editCode(User user, Project proj) {
		...
		try {
			...
			Action action = new Action("edit-code", proj.getKey(), user.getEmail());
